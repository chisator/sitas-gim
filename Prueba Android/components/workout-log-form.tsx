    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (existingLog) {
                ...
                // Delete old entries to replace (simpler than update individually)
                ...
                const { data: newLog, error: createError } = await supabase
                    ...
                    .insert({
                        ...
                        date: date,
                        notes: notes,
                        started_at: new Date().toISOString(), // Assuming completed now
            ...
            toast.success(existingLog ? "Registro actualizado" : "Registro creado")
